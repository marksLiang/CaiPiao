...
let TabBar_Title = ["首页","比赛","个人中心"]      //标题
let TabBar_StoryName = ["HomeMain","PlayGame","MineCenter"]  //sb名称（UI)
let TabBar_SelectedImage = ["homemain_select","playgame_select","minecenter_select"]        //选择的图片
let TabBar_NoSelectedImage = ["homemain_normal","playgame_normal","minecenter_normal"]      //未选择图片
