...
class YiJiaViewModel: NSObject {
    var ListData = [HotSpotModel]()//列表
    //国际足球列表
    func GetYiJiaList(PageIndex:Int , PageSize:Int ,result:((_ result:Bool?,_ NoMore:Bool?) -> Void)?) -> Void {
        let url = "http://118.178.1.136/v3/league/newsList?a8id=183814421826&channel=AppStore&id=5&leagueId=5&os_ver=10.3.3&platform=iOS&tag=2&title=%E6%84%8F%E7%94%B2&token=&type=0&uid=183814421826"
