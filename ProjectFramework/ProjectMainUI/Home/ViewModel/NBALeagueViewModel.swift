...
class NBALeagueViewModel: NSObject {
    var ListData = [HotSpotModel]()//列表
    //国际足球列表
    func GetNBALeagueList(PageIndex:Int , PageSize:Int ,result:((_ result:Bool?,_ NoMore:Bool?) -> Void)?) -> Void {
        let url = "http://118.178.1.136/v3/league/newsList?a8id=183814421826&channel=AppStore&id=1&leagueId=1&os_ver=10.3.3&platform=iOS&tag=2&title=NBA&token=&type=0&uid=183814421826"
