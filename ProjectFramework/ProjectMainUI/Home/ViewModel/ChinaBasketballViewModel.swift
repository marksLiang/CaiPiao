//
//  ChinaBasketballViewModel.swift
//  ProjectFramework
//
...
class ChinaBasketballViewModel: NSObject {
    var ListData = [HotSpotModel]()//列表
    //国际足球列表
    func GetChinaBasketballList(PageIndex:Int , PageSize:Int ,result:((_ result:Bool?,_ NoMore:Bool?) -> Void)?) -> Void {
        let url = "http://118.178.1.136/v3/league/newsList?a8id=183814421826&channel=AppStore&id=8&os_ver=10.3.3&platform=iOS&tag=1&tagId=8&title=%E4%B8%AD%E5%9B%BD%E7%AF%AE%E7%90%83&token=&type=0&uid=183814421826"
