...
class QuanYunHuiViewModel: NSObject {
    var ListData = [HotSpotModel]()//列表
    //国际足球列表
    func GetQuanYunHuiList(PageIndex:Int , PageSize:Int ,result:((_ result:Bool?,_ NoMore:Bool?) -> Void)?) -> Void {
        let url = "http://118.178.1.136/v3/league/newsList?a8id=183814421826&channel=AppStore&id=108&leagueId=108&os_ver=10.3.3&platform=iOS&tag=2&title=%E5%85%A8%E8%BF%90%E4%BC%9A&token=&type=0&uid=183814421826"
