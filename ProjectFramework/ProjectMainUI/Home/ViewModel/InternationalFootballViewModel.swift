//
//  InternationalFootballViewModel.swift
//  ProjectFramework
//
...
class InternationalFootballViewModel: NSObject {
    var ListData = [HotSpotModel]()//列表
    //国际足球列表
    func GetInternationalFootballList(PageIndex:Int , PageSize:Int ,result:((_ result:Bool?,_ NoMore:Bool?) -> Void)?) -> Void {
        let url = "http://118.178.1.136/v3/league/newsList?a8id=183814421826&channel=AppStore&id=4&os_ver=10.3.3&platform=iOS&sign=43ef5b2b543e6d7cce314a6cfd031b2f&tag=1&tagId=4&title=%E4%B8%AD%E5%9B%BD%E8%B6%B3%E7%90%83&token=&type=0&uid=183814421826"
