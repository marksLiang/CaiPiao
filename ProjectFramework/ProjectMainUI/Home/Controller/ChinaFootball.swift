...
class ChinaFootball: CustomTemplateViewController {

    @IBOutlet weak var tableView: UITableView!
    /********************  属性  ********************/
    fileprivate let identifier   = "PulickNewsCell"
    fileprivate let identifier1   = "PulickVideoCell"
    fileprivate var viewModel    = ChinaFootballViewModel()
    ...
    private func getHttpData()->Void{
        viewModel.GetChiNaFootballList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
