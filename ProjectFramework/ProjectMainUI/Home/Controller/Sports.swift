...
class Sports: CustomTemplateViewController {
    ...
    private func getHttpData()->Void{
        viewModel.GetSportsList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
