...
class QuanYunHui: CustomTemplateViewController {
    ...
    private func getHttpData()->Void{
        viewModel.GetQuanYunHuiList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
