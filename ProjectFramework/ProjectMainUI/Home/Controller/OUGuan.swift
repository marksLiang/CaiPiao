...
class OUGuan: CustomTemplateViewController {
    ...
    private func getHttpData()->Void{
        viewModel.GetOUGuanList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
