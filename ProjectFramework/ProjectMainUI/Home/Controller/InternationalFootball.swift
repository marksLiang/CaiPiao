...
class InternationalFootball: CustomTemplateViewController {
    
    @IBOutlet weak var tableView: UITableView!
    /********************  属性  ********************/
    fileprivate let identifier   = "PulickNewsCell"
    fileprivate let identifier1   = "PulickVideoCell"
    fileprivate var viewModel    = InternationalFootballViewModel()
    ...
    private func getHttpData()->Void{
        viewModel.GetInternationalFootballList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
