...
class DeJia: CustomTemplateViewController {
    ...
    private func getHttpData()->Void{
        viewModel.GetDeJiaList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
