...
class YingChao: CustomTemplateViewController {
    ...
    private func getHttpData()->Void{
        viewModel.GetYingChaoList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
