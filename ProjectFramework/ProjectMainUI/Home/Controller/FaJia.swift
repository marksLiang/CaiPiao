...
class FaJia: CustomTemplateViewController {
    ...
    private func getHttpData()->Void{
        viewModel.GetFaJiaList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
