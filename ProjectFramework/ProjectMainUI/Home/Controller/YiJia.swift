...
class YiJia: CustomTemplateViewController {
    ...
    private func getHttpData()->Void{
        viewModel.GetYiJiaList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
