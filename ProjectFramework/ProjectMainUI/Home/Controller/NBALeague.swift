...
class NBALeague: CustomTemplateViewController {
    ...
    private func getHttpData()->Void{
        viewModel.GetNBALeagueList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
