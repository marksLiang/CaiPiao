...
class XiJia: CustomTemplateViewController {
    ...
    private func getHttpData()->Void{
        viewModel.GetXiJiaList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
