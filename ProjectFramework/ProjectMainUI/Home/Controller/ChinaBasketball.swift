...
class ChinaBasketball: CustomTemplateViewController {

    @IBOutlet weak var tableView: UITableView!
    /********************  属性  ********************/
    fileprivate let identifier   = "PulickNewsCell"
    fileprivate let identifier1   = "PulickVideoCell"
    fileprivate var viewModel    = ChinaBasketballViewModel()
    ...
    private func getHttpData()->Void{
        viewModel.GetChinaBasketballList(PageIndex: PageIndex, PageSize: PageSize) { (result, Nomore) in
